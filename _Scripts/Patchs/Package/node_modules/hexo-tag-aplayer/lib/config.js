  ...
  _createClass(Config, [{
    ...
    value: function _parse(source) {
      ...
      if (source.cdn) {
        ...
        //this.set('script', _path2.default.join(this.root, '/', this.get('script_dir'), APLAYER_FILENAME));  //Out: \aa\xx\xxx.x        
		this.set('script', _path2.default.join(this.root, '/', this.get('script_dir'), APLAYER_FILENAME).replace(/\\/g,'/'));  //Fix:Out: /aa/xx/xxx.x	
      }
      ...
      if (source.style_cdn) {
        ...
        //this.set('style', _path2.default.join(this.root, '/', this.get('style_dir'), APLAYER_STYLENAME));  //Out: \aa\xx\xxx.x
        this.set('style', _path2.default.join(this.root, '/', this.get('style_dir'), APLAYER_STYLENAME).replace(/\\/g,'/'));  //Fix:Out: /aa/xx/xxx.x
      }
      ...
      if (source.meting !== false) {
        ...
        if (source.meting_cdn) {
          ...
          //this.set('meting_script', _path2.default.join(this.root, '/', this.get('script_dir'), METING_FILENAME));  //Out: \aa\xx\xxx.x
          this.set('meting_script', _path2.default.join(this.root, '/', this.get('script_dir'), METING_FILENAME).replace(/\\/g,'/'));  //Fix:Out: /aa/xx/xxx.x
        }
